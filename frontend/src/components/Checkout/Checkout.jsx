...
const Checkout = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center py-8">
      ...
      >
        <h5 className="text-white">Accéder au paiement</h5>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
      ...
      <form>
        ...
        <div className="w-full flex pb-3">
          <div className="w-[50%]">
            <label className="block pb-2">Adresse1</label>
            <input
              type="address"
              required
              value={address1}
          ...
          <div className="w-[50%]">
            <label className="block pb-2">Adresse2</label>
            <input
              type="address"
              value={address2}
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      ...
      <div className="flex justify-between border-b pb-3">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Réduction:</h3>
        <h5 className="text-[18px] font-[600]">
          - {discountPercentenge ? "$" + discountPercentenge.toString() : null}
        </h5>
      </div>
      <h5 className="text-[18px] font-[600] text-end pt-3">FCFA{totalPrice}</h5>
      <br />
